...
$lang['email_attachment_unredable'] = "No se ha podido abrir el fichero adjunto: %s";
$lang['email_no_recipients'] = "Debe incluir receptores: Para, CC, o BCC";
$lang['email_send_failure_phpmail'] = "No se puede enviar el correo usando la función mail() de PHP.  Su servidor puede no estar configurado para usar este metodo de envío.";
...
$lang['email_send_failure_smtp'] = "No se puede enviar el correo usando SMTP PHP. Su servidor puede no estar configurado para usar este método de envío.";
...
$lang['email_filed_smtp_login'] = "Fallo enviando el comando AUTH LOGIN. Error: %s";
